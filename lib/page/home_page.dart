...
import 'package:dapp_example/page/eth_conversions.dart';
import 'package:dapp_example/page/qr_scan_view_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  _showConnectDialog(BuildContext context) {
    showGeneralDialog(
        context: context,
  ...
  _connectToPreviousSession() {
    ...
    if (_sessionStore != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: const Text('No previous session found.'),
      ));
    }
  }
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const QRScanViewPage()),
                      ).then((value) {
                        if (value != null) {
                    ...
                    child: const Text('Connect Via Scan QR'),
                  ),
                ),
                const SizedBox(
                  height: 15,
